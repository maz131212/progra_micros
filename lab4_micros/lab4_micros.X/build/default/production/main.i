...
config_tmr0:
    ...
    bcf ((OPTION_REG) and 07Fh), 3 ;prescaler en tmr0
    bsf ((OPTION_REG) and 07Fh), 2 ;configurar el prescaler (111 = 1:256)
...
config_int:
    ...
    bsf ((INTCON) and 07Fh), 3 ;((INTCON) and 07Fh), 3=1 habilitar interrupciones de cambio puertoB
    bcf ((INTCON) and 07Fh), 0 ;apagar la bandera del IOC-PORTB
