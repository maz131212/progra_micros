...
# 1 "/Applications/microchip/xc8/v2.31/pic/include/xc.inc" 1 3
...
# 1 "/Applications/microchip/xc8/v2.31/pic/include/pic.inc" 1 3



# 1 "/Applications/microchip/xc8/v2.31/pic/include/pic_as_chip_select.inc" 1 3
# 2734 "/Applications/microchip/xc8/v2.31/pic/include/pic_as_chip_select.inc" 3
# 1 "/Applications/microchip/xc8/v2.31/pic/include/proc/pic16f887.inc" 1 3
# 48 "/Applications/microchip/xc8/v2.31/pic/include/proc/pic16f887.inc" 3
INDF equ 0000h
...
EECON2 equ 018Dh
# 2816 "/Applications/microchip/xc8/v2.31/pic/include/proc/pic16f887.inc" 3
...
# 2735 "/Applications/microchip/xc8/v2.31/pic/include/pic_as_chip_select.inc" 2 3
# 5 "/Applications/microchip/xc8/v2.31/pic/include/pic.inc" 2 3
...
auto_size SET 0
ENDM
# 8 "/Applications/microchip/xc8/v2.31/pic/include/xc.inc" 2 3
# 17 "main.s" 2
...
config_io:
    ...
    bsf TRISA, 4 ;puerto ((PORTA) and 07Fh), 4 como entrada
    bsf TRISA, 5 ;puerto ((PORTA) and 07Fh), 5 como entrada
    bsf TRISA, 6 ;puerto ((PORTA) and 07Fh), 6 como entrada
    bsf TRISA, 7 ;puerto ((PORTA) and 07Fh), 7 como entrada

    clrf TRISB ;puerto B como salida
    bsf TRISB, 0 ;puerto ((PORTB) and 07Fh), 0 como entrada
    bsf TRISB, 1 ;puerto ((PORTB) and 07Fh), 1 como entrada

    bcf OPTION_REG, 7 ;RBPU=0, habilitar los pull-ups del puerto B
    bsf WPUB, 0 ;habilitar pull-up ((PORTB) and 07Fh), 0
...
config_reloj:
    banksel OSCCON
    bsf ((OSCCON) and 07Fh), 6 ;oscilador de 4 MHz (110)
    bsf ((OSCCON) and 07Fh), 5
    bcf ((OSCCON) and 07Fh), 4
    bsf ((OSCCON) and 07Fh), 0 ;OSCILADOR INTERNO
    return

config_int:
    banksel INTCON
    bsf INTCON, 7 ;((INTCON) and 07Fh), 7=1 habilitar las interrupciones globales
    bsf INTCON, 3 ;((INTCON) and 07Fh), 3=1 habilitar interrupciones de cambio puertoB
    bcf ((INTCON) and 07Fh), 0
    ;bsf INTCON, 2 ;((INTCON) and 07Fh), 2=1 habilitar interrupciones Timer0
    return

config_iocportb:
    banksel IOCB
    bsf IOCB, 0 ;habilitar interrupt-on-change ((PORTB) and 07Fh), 0
