...
config_reloj:
    banksel OSCCON
    bcf ((OSCCON) and 07Fh), 6 ;oscilador de 125 KHz (001)
...
config_tmr0:
    ...
    bcf ((OPTION_REG) and 07Fh), 2 ;configurar el prescaler (000 = 1:2)
...
config_tmr2:
    ...
    bcf ((T2CON) and 07Fh), 1 ;configurar el prescaler (01 = 1:4)
