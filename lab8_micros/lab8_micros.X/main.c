    ...
    { 
        switch(bandera){
            case(0):
                ...
                PIR1bits.ADIF = 0;  
                bandera = 1;
                ADCON0bits.CHS = 10; //AN10 en el PORTB0
                break;
            case(1):
                VAR = ADRESH;
                PIR1bits.ADIF = 0;
                bandera = 0;
                ADCON0bits.CHS = 12; //AN12 en el PORTB1
                break;
            }
...
void setup(void) {
    ...
    ANSELH = 0x14; // PARA USARLO COMO ANALOGICO
    ...
    ADCON0bits.CHS = 12; //AN12 en el PORTB0
    __delay_us(50);
