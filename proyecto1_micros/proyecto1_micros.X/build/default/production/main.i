...
config_io:
    ...
    bsf TRISB, 3 ;puerto ((PORTB) and 07Fh), 0 como entrada
    bsf TRISB, 4 ;puerto ((PORTB) and 07Fh), 1 como entrada
    bsf TRISB, 5 ;puerto ((PORTB) and 07Fh), 2 como entrada
    bsf TRISB, 6 ;puerto ((PORTB) and 07Fh), 6 como entrada
    bsf TRISB, 7 ;puerto ((PORTB) and 07Fh), 7 como entrada
    bcf OPTION_REG, 7 ;RBPU=0, habilitar los pull-ups del puerto B
    bsf WPUB, 3 ;habilitar pull-up ((PORTB) and 07Fh), 0
    bsf WPUB, 4 ;habilitar pull-up ((PORTB) and 07Fh), 1
    bsf WPUB, 5 ;habilitar pull-up ((PORTB) and 07Fh), 2
